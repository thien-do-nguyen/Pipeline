...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Reconcile coordinated Gold from Unified Silver")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    try:
        ...
        batch_id = f"gold-reconcile-{new_batch_id(config.application.timezone)}"
